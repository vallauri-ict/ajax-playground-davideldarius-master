...
?>
  <div class="container">
  	<form  action="addjob.php" method="post" class="form-addjob">
		<h1 class="form-signin-heading text-muted text-center">Informazioni</h1>
        ...
        <br>
        <input type="text" class="form-control" name="location" placeholder="Città" required />
        <br>
		...
		<br>
		<input class="btn btn-lg btn-primary btn-block" name="submit" type="submit" value="Aggiungi Lavoro" />
	</form>
  </div>
