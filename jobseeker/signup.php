...
<div class="container">
	...
	<form action="signup.php" method="post"class="form-signin">
		...
		<br>
		<input type="password" name="password2" class="form-control" placeholder="Conferma Password" required />
		<br>
		...
		<br>
		<input class="btn btn-lg btn-primary btn-block" name="submit" type="submit" value="Registrati" />
	</form>
